    ...
    herbs.forEach((herb) => {
      if (herb.origin) {
        herb.origin.forEach((origin) => {
          // 简单的省份名称匹配
          const matchedProvince = Object.keys(CHINA_PROVINCES).find(
            (province) => origin.includes(province) || province.includes(origin)
          )
                  ...
                  .map(([province, data], index) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold text-blue-600">{data.herbCount} 种</span>
                      </div>
