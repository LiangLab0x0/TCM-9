        ...
        <div className="space-y-2 mb-4">
          {slice.processing.temperature && (
            <div className="flex items-center text-sm text-gray-600">
              ...
              <span>温度: {slice.processing.temperature.value}{slice.processing.temperature.unit}</span>
            </div>
          )}
          ...
          {slice.processing.duration && (
            <div className="flex items-center text-sm text-gray-600">
              ...
              <span>时长: {slice.processing.duration.value}{slice.processing.duration.unit}</span>
            </div>
          )}
