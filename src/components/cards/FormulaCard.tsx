...
import { calculateFormulaWeight } from '../../types/tcm-core'
...
export const FormulaCard: React.FC<FormulaCardProps> = ({ formula }) => {
  const { setSelectedFormula, setCurrentView, addToCompareFormulas, compareFormulas } =
    useNewAppStore()
      ...
      <div className="relative h-48 overflow-hidden bg-gradient-to-br from-indigo-50 to-purple-50">
        ...
        <button
          ...
          className={`absolute top-3 right-3 p-2 rounded-full transition-colors ${
            isInCompare ? 'bg-indigo-600 text-white' : 'bg-white/80 hover:bg-white text-gray-700'
          }`}
        >
      ...
      <div className="p-4">
        ...
        <div className="mb-3">
          <div className="flex items-center text-sm text-gray-700 mb-2">
            ...
            <span>
              共{formula.components.length}味药，{totalWeight}g
            </span>
          </div>
